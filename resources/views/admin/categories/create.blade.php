...
<head>
    ...
    <title>New Category - ModeraHome</title>
    ...
    <div class="max-w-2xl mx-auto px-6 py-6">
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" id="categoryForm">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" value="{{ old('name') }}" required placeholder="e.g. Living Room" class="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500">
                @error('name')
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="3" placeholder="Category description..." class="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description') }}</textarea>
            </div>
